...
As the test target of this project as an example used the website https\://www.target.com/ to verify basic functionalities: Login, Home page, Search Product, List of products and product forms, Checkout validation.
